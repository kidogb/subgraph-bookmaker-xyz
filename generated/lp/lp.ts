...
export class lpAdminChanged extends ethereum.Event {
  get params(): lpAdminChanged__Params {
    return new lpAdminChanged__Params(this);
  }
}

export class lpAdminChanged__Params {
  _event: lpAdminChanged;

  constructor(event: lpAdminChanged) {
    this._event = event;
  }
...
export class lpBeaconUpgraded extends ethereum.Event {
  get params(): lpBeaconUpgraded__Params {
    return new lpBeaconUpgraded__Params(this);
  }
}

export class lpBeaconUpgraded__Params {
  _event: lpBeaconUpgraded;

  constructor(event: lpBeaconUpgraded) {
    this._event = event;
  }
...
export class lpUpgraded extends ethereum.Event {
  get params(): lpUpgraded__Params {
    return new lpUpgraded__Params(this);
  }
}

export class lpUpgraded__Params {
  _event: lpUpgraded;

  constructor(event: lpUpgraded) {
    this._event = event;
  }
