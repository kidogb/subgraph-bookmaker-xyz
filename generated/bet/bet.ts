...
export class betAdminChanged extends ethereum.Event {
  get params(): betAdminChanged__Params {
    return new betAdminChanged__Params(this);
  }
}

export class betAdminChanged__Params {
  _event: betAdminChanged;

  constructor(event: betAdminChanged) {
    this._event = event;
  }
...
export class betBeaconUpgraded extends ethereum.Event {
  get params(): betBeaconUpgraded__Params {
    return new betBeaconUpgraded__Params(this);
  }
}

export class betBeaconUpgraded__Params {
  _event: betBeaconUpgraded;

  constructor(event: betBeaconUpgraded) {
    this._event = event;
  }
...
export class betUpgraded extends ethereum.Event {
  get params(): betUpgraded__Params {
    return new betUpgraded__Params(this);
  }
}

export class betUpgraded__Params {
  _event: betUpgraded;

  constructor(event: betUpgraded) {
    this._event = event;
  }
